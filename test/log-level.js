describe('[desktop] log.js', function(){
  
  require('should');

  var logger = require('../lib/log');

  var log, buffer, reallog, default_level = process.env.LOGDESKTOP;
  ...
  function unproxy(){
    console.log = reallog;
    process.env.LOGDESKTOP = default_level;
  }

  function log_all(level) {
    process.env.LOGDESKTOP = level;
